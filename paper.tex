...
\author{
\alignauthor \fontsize{10.7}{9.9}\selectfont Anirudh Sivaraman\textsuperscript{\P}, Mihai Budiu\textsuperscript{\S}\thanks{Work done when employed at Barefoot Networks.}~, Alvin Cheung\textsuperscript{\ddag}, Changhoon Kim\textsuperscript{\dag}, Mohammad Alizadeh\textsuperscript{\P}, Hari Balakrishnan\textsuperscript{\P}, George Varghese\textsuperscript{++}, Nick McKeown\textsuperscript{+}, Steve Licking\textsuperscript{\dag}\\
\affaddr \fontsize{9.6}{9.9}\selectfont\hspace{-0.15in} \textsuperscript{\P}MIT CSAIL, \textsuperscript{\S}VMWare Research, \textsuperscript{\ddag}University of Washington, \textsuperscript{\dag}Barefoot Networks, \textsuperscript{++}Microsoft Research, \textsuperscript{+}Stanford University
}
