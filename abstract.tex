...
language and convert those programs into low-level microcode that can run on
emerging programmable line-rate switching
...
imperative language to express switch algorithms. 
%The \pktlanguage
%compiler produces code executable on \absmachine, a machine model for
%programmable switches. 
We show with many examples that \pktlanguage provides a convenient and
natural way to express sophisticated data-plane algorithms, and show
that they can run at line-rate with modest estimated die-area
overhead.
