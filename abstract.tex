...
queue management, and link load balancing require custom processing of packets
...
programmable line-rate switching chipsets. The key challenge is that many
...
and isolated from other such code blocks. We have developed this idea in
\pktlanguage, a C-like imperative language to express data-plane algorithms. We
show with many examples that \pktlanguage provides a convenient way to express
