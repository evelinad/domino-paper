...
algorithmic state. We present \pktlanguage, a C-like imperative
language to express data-plane algorithms. \pktlanguage introduces the
notion of a {\em packet transaction}: a sequential code block that is
atomic and isolated from other such code blocks.  The \pktlanguage
...
line-rate hardware execution can be achieved with modest die area
overhead.
