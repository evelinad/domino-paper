...
compiler produces code executable on \absmachine, a machine model
for programmable switches. We
show that \pktlanguage provides a simpler programming model than P4, a
recent language for such switches, and
