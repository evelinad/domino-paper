...
programmable switches. We show that data-plane algorithms are more
naturally expressed in \pktlanguage than P4 (a recent language for
such switches), and estimate that several algorithms written in Domino
achieve line-rate performance with modest die area overhead.
