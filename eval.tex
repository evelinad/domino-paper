...
Table~\ref{tab:algos} to determine if each algorithm is implementable using a
...
programmers continuously push the boundaries of these chips with new algorithms.
