...
\hline
Bloom filter~\cite{bloom} (3 hash functions) & Set membership bit on every packet. & Write & 4, 3 & Either & 29 & 104 \\
\hline
...
\hline
Compute priorities for weighted fair queueing~\cite{pifo_hotnets} & Compute packet's virtual start time using finish time of last packet in that flow. & Nested & 4, 2 & Ingress & 29 & 87 \\
\hline
