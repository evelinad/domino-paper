...
atom, assuming a chip area of 200 $mm^2$ (the smallest area given by Gibb et.
...
the area of 1384 $\mu m^2$ per instance.  If these 10000 atoms were to be
...
the most complex stateful atom (Pairs) with an area of 5997 $\mu m^2$.
...
this, we rely on RMT~\cite{rmt}, which estimates a crossbar area of 6 $mm^2$
for a 32-stage pipeline with 224 action units. Scaling this proportionally to
300 stateless atoms, we estimate a crossbar area of 8 $mm^2$ for a 4\% area
overhead.
