...
\hline
Learning bloom filter & \pbox{0.65\textwidth}{Set membership bit on every packet.\footnote{We call this a learning filter because it ``learns'' of a new packet by adding it to the set. For packets that were already in the set, this operation has no effect.}}\\
\hline
...
\hline
Periodic sampling & \pbox{0.65\textwidth}{Sample/Mark a packet if packet count reaches N; reset count at N.} \\
\hline
