...
\hline
\pbox{0.16\textwidth}{Priority computation\\for weighted fair queueing~\cite{pifo_hotnets}} & \pbox{0.34\textwidth}{Compute packet's virtual start time using\\finish time of last packet in that flow.} & Nested & 4, 2 & Ingress & 29 & 87 \\
\hline
\pbox{0.16\textwidth}{DNS TTL change\\tracking~\cite{dns_change}} & Track number of changes in announced TTL for each domain & Nested & 6,3 & Ingress & 27 & 119 \\
\hline
