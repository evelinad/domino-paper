...
This is because switch designers would prefer to design, implement, verify, and
optimize (at the gate level) one circuit for all stateful operations, thereby
amortizing design effort.  Table~\ref{tab:templates} gradually increases the
capability of this single atom template.  We designed the atoms in
Table~\ref{tab:templates}, and hence the \absmachine machines providing them,
to form a containment hierarchy: each atom can express all data-plane
