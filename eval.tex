...
\begin{table}[!t]
  ...
  compiler targets contains one of the seven stateful atoms (Read/Write to Pairs)
  and the single stateless atom.}
  \label{tab:templates}
\end{table}
...
\begin{table}[!t]
  ...
  \end{tabular}
\end{scriptsize}
\caption{An atom's minimum critical-path delay increases with circuit depth. MUX
