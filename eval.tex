...
physically layout one circuit for all stateful operations, thereby amortizing
design and layout effort over multiple instances of the same circuit.
...
\subsection{A performance-programmability tradeoff}
