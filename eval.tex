...
\hline
\pbox{0.16\textwidth}{Compute priorities\\for weighted fair\\queueing~\cite{pifo_hotnets}} & \pbox{0.34\textwidth}{Compute packet's virtual start time using\\finish time of last packet in that flow.} & Nested & 4, 2 & Ingress & 29 & 87 \\
\hline
