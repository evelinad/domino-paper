...
directly capture an algorithm's intent pervades programming models for any
other networking device: software routers~\cite{click}, network
...
standard-cell library with $< 2\%$ chip area cost relative to a baseline
switching chip of size 200 \si{\milli\metre\squared}~\cite{gibb_parsing}.
