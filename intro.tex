...
To evaluate \pktlanguage, we express algorithms such as RCP~\cite{rcp},
...
% One theme: High-level programming for line-rate switches
% Three contributions: A model for hardware with state, a programming model, and a compiler
% Two evaluations / findings:
% 1. Using \pktlanguage is easier than P4.
% 2. We design a set of compiler targets and show they are feasible in today's technology.
% 3. We show that these compiler targets can express the algorithms that we have.
% TODO: Stress that stateful algorithms are the ones that need most work.
% Give examples of these algorithms in addition to what we have: scheduling, DDoS, Bohatei, etc.
