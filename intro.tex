...
% and adds modest area overhead for
%programmability

%Programmable switching chips \ac{programmable switches}
...
%To the best of our knowledge, \pktlanguage is the first high-level
%imperative language for programming the data plane of line-rate
%switches.
...
hardware rate, or not at all. Performance is not just predictable, but
is guaranteed.

%---unlike software platforms that have smoother
