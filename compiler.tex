...
%TODO: Make sketching and strongly connected components more prominent and emphasize
% what's new/interesting about them. 
% 
%TODO why does our design achieve (ordered) transactions?
%TODO why is it beneficial?
...
\label{ss:pipelining}
%TODO: What is new/new application in Pipelining relative to prior work?

% in that it operates on a
...
\begin{CompactEnumerate}
  ...
  \item Now, add {\em stateless dependencies} by adding an edge from any node
    ...
    pkt.tmp > THRESHOLD} in Figure~\ref{fig:partitioning_before}. We only check read-after-write dependencies because
...
%TODO: Maybe color edges differently for stateful and stateless ops
\end{figure*}
...
% TODO: Don't cite rau. It doesn't mention SCCs anywhere.
...
%Domino's SSA computation operates on straight-line code and doesn't
