...
\begin{table}[!t]
  ...
  \hline
  Strongly Connected Components & Lam~\cite{lam} & Scheduling in space vs. time \\ % Mention Rau, software pipelining.
  \hline
...
%TODO: Fuse the three textbf sections below into one Discussion section
% relating the compiler techniques to prior compiler work.
