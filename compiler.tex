...
implementation (Figure~\ref{fig:flowlet_pipeline}). We verify correctness by feeding in
...
this proposal were to be approved, \pktlanguage could target P4 as a backend,
which would then allow \pktlanguage to target programmable switches by
