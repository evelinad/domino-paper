...
temporaries~(Figure~\ref{fig:three_address}). Flattening to three-address code breaks down
...
longer any  nested expressions. The simpler form of three-address code statements
