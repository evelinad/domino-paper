...
running the resulting binary on a \absmachine instance.
...
equivalent to an atom available in the \absmachine instance. If the \absmachine
instance supports complex atoms beyond three-address code instructions, this
approach is still correct, although suboptimal. For instance, if the
\absmachine instance supports a multiply-and-accumulate atom~\cite{mac},
...
Because different \absmachine instances only differ in the atoms they provide,
