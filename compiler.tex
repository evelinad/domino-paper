...
\label{fig:ssa}
\end{figure*}
% TODO: Mention how we rename all definitions, because it's just simpler.
...
\end{figure*}
% TODO: Regenerate this code (this one's taken from the proposal) and explain
% why it is reordered. George and Alvin were both confused by this.
...
%TODO: Do we mention CSE here? Seems like the appropriate location.
