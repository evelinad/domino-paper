...
atom. The codelet is a specification that is to be matched for functional
...
On the other hand, if the codelet x = x * x was supplied as the SKETCH
specification, SKETCH would return an error because the specification cannot be
mapped to any of the computations provided by the atom template.
