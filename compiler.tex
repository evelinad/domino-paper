...
We use the following algorithm to create the codelet pipeline for the pipelined
...
within a stage.
%TODO: Ensure that either one of width of a pipeline stage and number of atoms
%per stage is used; not both.
...
% TODO: Don't intermix "conversion to straight-line code with branch removal". Use one or the other.
