...
The design of \pktlanguage's compiler is guided by this goal of all-or-nothing
compilation and consists of three passes (Figure~\ref{fig:passes}).  First,
\textit{normalization} simplifies the packet transaction into the very
...
passes. While the \pktlanguage compiler uses many existing compiler techniques,
it adapts and simplifies them in important ways to suit the domain of line-rate
switches; we comment on these differences in \S\ref{ss:related_compiler}.
