...
the index \texttt{pkt.id}, which takes on only one value for a given packet, but can change
...
\begin{table}
  \begin{tabular}{p{0.95\columnwidth}}
   ...
   Each transaction execution accesses an array at exactly one index.\\
