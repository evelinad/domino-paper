...
As an illustration of the restrictions, arrays can be used as state variables
...
%\ac{how is this enforced?}
%It isn't :) because I didn't get around to writing a validator pass yet.
