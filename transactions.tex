...
but otherwise does not interpret or analyze intrinsics. Intrinsics are hardware
primitives provided by the abstract machine that are not interpreted by
\pktlanguage. 
...
%TODO: Hari's point
% Write about how line-rate or nothing is a good programming model
% that gives us all considerable peace of mind.
