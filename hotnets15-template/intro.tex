...
For instance, simple\_router.p4~\cite{simple_router.p4} is a program that
...
% The way the code is structured is to have three "seemingly" sequential
% statements that are: x, y, and z.  But, hidden beneath this sequential
% structure are statements that are actually executed in parallel.  Needless to
% say, this intermixing of sequential and parallel semantics is very hard for
% programmer to convince herself of the correctness of the program.
